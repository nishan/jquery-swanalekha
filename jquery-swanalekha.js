...
widget.style.outline = options.outlineStyle;
if (widget.checkBox) widget.checkBox.firstChild.checked = true;
widget.aBound = true;
};
function disable(){
...
if (widget.checkBox) widget.checkBox.firstChild.checked = false;
widget.aBound = false;
};
...
function keypressEnabled(event){
	...
	var cha=String.fromCharCode(kCode );
...
if(isToggleEvent(event)){
enable();
if (widget.checkBox) widget.checkBox.checked = true;
widget.aBound = true;
return false;
}
return true;
